          ...
          <SubCard title="primary Color">
            <Grid container spacing={gridSpacing}>
              <Grid item xs={12} sm={6} md={4} lg={2}>
                <ColorBox
                  bgcolor="primary.light"
                  data={{ label: 'Green-A100', color: theme.palette.primary.light }}
                  title="primary.light"
                  dark
                />
              </Grid>
              <Grid item xs={12} sm={6} md={4} lg={2}>
                <ColorBox bgcolor="primary.200" data={{ label: 'Green-A200', color: theme.palette.primary[200] }} title="primary[200]" />
              </Grid>
              <Grid item xs={12} sm={6} md={4} lg={2}>
                <ColorBox bgcolor="primary.main" data={{ label: 'Green-A400', color: theme.palette.primary.main }} title="primary.main" />
              </Grid>
              <Grid item xs={12} sm={6} md={4} lg={2}>
                <ColorBox bgcolor="primary.dark" data={{ label: 'Green-A700', color: theme.palette.primary.dark }} title="primary.dark" />
              </Grid>
            </Grid>
          </SubCard>
        </Grid>
