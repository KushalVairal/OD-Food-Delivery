        ...
        <Grid container spacing={gridSpacing}>
            ...
            <Grid item xs={12}>
                <SubCard title="primary Color">
                    <Grid container spacing={gridSpacing}>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="primary.light" data={{ label: 'Green-A100', color: '#b9f6ca' }} title="primary.light" dark />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="primary.main" data={{ label: 'Green-A200', color: '#69f0ae' }} title="primary[200]" />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="primary.main" data={{ label: 'Green-A400', color: '#69f0ae' }} title="primary.main" />
                        </Grid>
                        <Grid item xs={12} sm={6} md={4} lg={2}>
                            <ColorBox bgcolor="primary.dark" data={{ label: 'Green-A700', color: '#00c853' }} title="primary.dark" />
                        </Grid>
                    </Grid>
                </SubCard>
            </Grid>
